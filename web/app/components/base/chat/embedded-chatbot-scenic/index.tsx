...
import Header from '@/app/components/base/chat/embedded-chatbot-scenic/header'
import ConfigPanel from '@/app/components/base/chat/embedded-chatbot-scenic/config-panel'
import ChatWrapper from '@/app/components/base/chat/embedded-chatbot-scenic/chat-wrapper'
      ...
      <div className='flex bg-white overflow-hidden'>
        <div className={cn('h-[100vh] grow flex flex-col overflow-y-auto', isMobile && '!h-[calc(100vh_-_3rem)]')}>
          ...
          {chatReady && !appChatListDataLoading && (
            <div className='relative h-full mx-auto w-full max-w-[720px] bg-background-body'>
              {!isMobile && (
