...
const Chat: FC<ChatProps> = ({
  ...
  const getShortcutListItem = (title: string, subTitle: string) => (
    <div className='h-16 w-40 rounded-xl bg-white p-3'>
  ...
  const getSptWidgetComponent = (item: ChatItem) => (
    <div className='mb-[30px] rounded-[20.8px] border border-green-50 p-[16px]' style={{
      backgroundColor: 'rgb(235,235,236,0.4)',
    }}>
      <div className='flex w-full justify-between'>
        <div>
          <h1 className='mt-1 text-[25px]'>Hi,下午好</h1>
