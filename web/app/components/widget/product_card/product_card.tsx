...
const ProductCardPlat = ({ product, key }: { product: ProductInfo; key: string | number }) => {
  return (
    <a key={key} href={product.productPageUrl} target='_blank' rel='noopener noreferrer'>
      <div className='flex h-[70px] w-full overflow-hidden rounded-xl bg-white'>
        <div>
          {product.coverImg && (
            <img
